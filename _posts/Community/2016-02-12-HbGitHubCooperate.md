...
近期看到不少同伴使用 GitHub 协作，我开始理解当初大妈和我协作时的痛苦感受----这不顺眼那不专业，虽不至酿成大错，但实在让人浑身不自在。遂复盘自己踩坑经历（其实就是被大妈咆哮调教的经历T_T）整理几大常见业余姿势，让更多小伙伴少走弯路，更快体会 GitHub 协作的舒爽乐趣。

注意：

- 本文适用于了解 GitHub 是什么的小伙伴，否则请先移步 GitHub 基础教程：
...
嗯哼，如果你绕过以上两坎，那来看看我被咆哮嫌弃 N 次的业余姿势吧……
...
- OM2Py 的学员仓库中`优秀学员示范` `C2T2` `公告` `Doc`（关闭了 wiki 模块，所以增设了 Doc 标签）
...
Anyway，Issue 可供性非常强大，团队内形成默契的使用礼仪，用对 GitHub 的 Issue，将会幸福无比！
